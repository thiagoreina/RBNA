...
?>
  <?php
	...
	$qtdsoldadores = 		$_POST["qtdsoldadores"];
...
$sql2 = "UPDATE obras_ok SET registro = '".$registro."',
contratante = '".$contratante."',
regiao = '".$regiao."',
pagamento = '".$pagamento."',
servico = '".$servico."',
qtdsoldadores = '".$qtdsoldadores."',
qtddias = '".$qtddias."',
obs = '".$obs."',
forarbna = ".$forarbna.",
certrbna = ".$certrbna.",
...
insatisfeitos = ".$insatisfeitos." WHERE id =".$id;
 ...
 $sqlregistro = "select * from obras_ok where registro = '".$registro."' ";
