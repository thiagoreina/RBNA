...
<p>&nbsp;</p>
<form action="gravar_funcionario.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" ><table width="80%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td colspan="5" bgcolor="#666666"><div class="solicitacao">
      <div align="center" class="title">Cadastro de Funcionarios</div>
    </div></td>
    </tr>
  <tr>
    <td width="15%" bgcolor="#DFDFDF"><div class="solicitacao"><div class="texto">Nome:</div></div></td>
    <td colspan="2" bgcolor="#F7F7F7"><div class="solicitacao">
      <label for="nome"></label>
      <span class="aviso"><input name="nome" type="text" class="required" id="nome" size="25" />
      </span></div></td>
    <td width="14%" bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto">Sobrenome:</div>
    </div></td>
    <td width="29%" bgcolor="#F7F7F7"><div class="solicitacao">
      <div class="texto">
        <input name="sobrenome" type="text" class="required" id="sobrenome" size="25" />
      </div>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#DFDFDF"><div class="solicitacao"><div class="texto">Setor:</div></div></td>
    <td width="12%" bgcolor="#F7F7F7"><span class="aviso"><div class="solicitacao"><label>
    ...
    <td width="30%" bgcolor="#F7F7F7"><div class="solicitacao">
      <div align="left"><a href="javascript:MM_openBrWindow('cad_setor.php','edit','scrollbars=yes,width=500,height=400')"><img src="../imagens/add.png" width="20" height="20" alt="Cadastrar Setor" title="Cadastrar Setor" /></a></div></td>
    <td bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto">Matricula:</div></div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao">
      <div class="texto"><input name="matricula" class="required" type="text" id="matricula" size="25" />
      </div></div></td>
  </tr>
  <tr>
    <td bgcolor="#DFDFDF"><div class="solicitacao"><div class="texto">Data de Nascimento:</div></div></td>
    <td colspan="2" bgcolor="#F7F7F7"><div class="solicitacao"><span class="aviso">
      <label for="textfield2"></label><input name="data_nasc" type="text" class="required" id="data" size="25" />
    </span>
    </div></td>
    <td bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto">admissão:</div></div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao">
      <div class="texto"><span class="aviso">
        <input name="admissao" class="required" type="text" id="admissao" size="25" />
      </span></div></div></td>
  </tr>
  <tr>
    <td bgcolor="#DFDFDF"><div class="solicitacao"><div class="texto">Email:</div></div></td>
    <td colspan="4" bgcolor="#F7F7F7"><div class="solicitacao"><span class="aviso">
      <label for="textfield3"></label>
      <input name="email" type="text" class="required email" id="email" size="25" />
    </span></div></td>
  </tr>
  <tr>
    <td bgcolor="#DFDFDF"><div class="solicitacao"><div class="texto">Ramal:</div></div></td>
    <td colspan="4" bgcolor="#F7F7F7"><div class="solicitacao">
      <label for="ramal"></label>
      <input name="ramal" type="text" id="ramal" size="25" />
      <label for="foto"></label>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#DFDFDF"><div class="solicitacao"><div class="texto">Foto:</div></div></td>
    <td colspan="2" bgcolor="#F7F7F7"><div class="solicitacao">
      <input type="file" title="Selecione a Foto" name="foto" />
    </div></td>
    <td bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto">Ficha:</div>
    </div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao">
      <input name="ficha" type="file" accept=".pdf" id="ficha" />
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#DFDFDF"><div class="texto"><div class="solicitacao">Celular:</div></div></td>
    <td colspan="2" bgcolor="#F7F7F7"><div class="solicitacao">
      <label for="textfield5"></label>
      <input name="celular" type="text" id="tel" size="25" />
    </div></td>
    <td colspan="2" bgcolor="#DFDFDF">
      <div class="texto">
        <div class="texto"><div class="solicitacao"><input type="checkbox" name="gerente" id="checkbox" value="1" />
          <label for="checkbox"> 
            Gerente:
            </label></div></div>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#F7F7F7"><div class="solicitacao"><div align="center" class="aviso">
