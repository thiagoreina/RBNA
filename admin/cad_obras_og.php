...
<div align="center">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title"> Cadastro de Obras OG</div></td>
...
<p>&nbsp;</p>
<form action="gravar_obras_og.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" >
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Cadastro de Obras OG<span class="texto"></span></div>
      </div></td>
    </tr>
    <tr>
