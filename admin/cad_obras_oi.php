...
<div align="center">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title"> Cadastro de Obras OI</div></td>
...
<p>&nbsp;</p>
<form action="gravar_obras_oi.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" >
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Cadastro de Obras OI</div>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F7F7F7"><div class="texto">
        <div class="solicitacao">
          <input name="embarcacao" type="text" class="required" id="textfield3" size="100" />
          </span></div>
      </div></td>
    </tr>
    <tr>
      ...
      <td width="39%" bgcolor="#F7F7F7"><div class="solicitacao">
        <input type="text" name="material" id="textfield" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
    ...
    <tr>
      ...
      <td bgcolor="#F7F7F7"><div class="texto">
        <div class="solicitacao">
      ...
      <td bgcolor="#F7F7F7"><div class="solicitacao">
        <input type="text" name="numerocasco" id="textfield4" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
