...
<div align="center">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title"> Cadastro de Obras OK</div></td>
...
<p>&nbsp;</p>
<form action="gravar_obras_ok.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" >
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Detalhes da Obra OK</div>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td bgcolor="#F7F7F7"><div class="solicitacao">
        <input type="text" name="qtdsoldadores" id="qtdsoldadores" />
      </div></td>
    </tr>
