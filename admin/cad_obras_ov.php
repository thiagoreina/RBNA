...
<div align="center">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title"> Cadastro de Obras OV</div></td>
...
<p>&nbsp;</p>
<form action="gravar_obras_ov.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" ><table width="90%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td colspan="5" bgcolor="#666666"><div class="solicitacao">
      <div align="center" class="title">Cadastro de Obras OV</div>
    </div></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpretoB">QNT. DIAS:</div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <input type="text" name="qntddias" id="textfield7" />
    </div></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
    ...
    <td colspan="3" bgcolor="#E9E9E9"><label for="servico"></label>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#E9E9E9"><span class="solicitacao">
      <textarea name="servico" id="servico" cols="80" rows="5"></textarea>
    </span></td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
