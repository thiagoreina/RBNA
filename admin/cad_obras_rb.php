...
<div align="center">
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title">Cadastro de Obras RB</div></td>
...
<p>&nbsp;</p>
<form action="gravar_obras_rb.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" >
<div class="input_container">
  <input name="cliente" type="text"  id="country_id"  placeholder="Selecione o Cliente" class="required" onkeyup="autocomplet()" />
...
<table width="90%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td colspan="5" bgcolor="#666666"><div class="solicitacao">
      <div align="center" class="title">Cadastro de Obras RB    </div>
    </div></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="28%" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="texto"><span class="textomenorpretoB">Nº CASCO:</span></div>
    </div></td>
  ...
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpretoB">REGIME DEPAGAMENTO:</div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
  ...
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="texto">
      <div class="textomenorpretoB">BANDEIRA:</div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <label for="armador"></label>
      <input type="text" name="bandeira" id="textfield9" class="required" />
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpretoB">COMPRIMENTO (L):</div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <input type="text" name="comprimento" id="textfield5" />
    </div></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpretoB">AB:</div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <input type="text" name="ab" id="textfield6" />
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="texto"><span class="textomenorpretoB">KW:</span></div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
    ...
    <td colspan="3" bgcolor="#E9E9E9"><label for="obs"></label>
      <div class="solicitacao">
        <table width="100%" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td width="6%" bgcolor="#999999"><div align="center">
              <input type="checkbox" name="forarbna" id="forarbna" value="1" />
            </div>
              <label for="forarbna"></label><div align="center"></div></td>
            <td width="45%" bgcolor="#EAEAEA"><span class="textomenorpreto">Embarcação que não está no RBNA</span></td>
            <td width="6%" bgcolor="#000000"><div align="center">
              <input type="checkbox" name="certrbna" id="certrbna" value="1" />
            </div>
              <label for="certrbna"></label></td>
            <td width="43%" bgcolor="#EAEAEA" class="textomenorpreto">Embarcação certificada pelo RBNA</td>
            </tr>
          </table>
      </div></td>
    </tr>
