...
<div class="clear">
    <p></p>
    <form id="form1" name="form1" method="post" action="enviar_relatorio.php">
      <table width="90%" border="0" cellpadding="2" cellspacing="2">
        <tr>
          <td colspan="5" bgcolor="#666666"><div class="solicitacao">
            <div align="center" class="title">Enviar Relatórios</div>
          </div></td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
              <div class="textomenorpretoB">OBRA:</div>
          </div></td>
          <td colspan="3" bgcolor="#E9E9E9"><div class="solicitacao"><span class="texto">
            <?php
	 ...
	 if (mysql_num_rows($resultrb) > 0) {
			
		$rowrb = mysql_fetch_array($resultrb);
		echo "[".$rowrb["registro"]."] ". $rowrb["embarcacao"];
        ...
        <tr>
          ...
          <td width="20%" bgcolor="#E9E9E9"><div class="solicitacao"><span class="texto">
          <?php 
		  $sqltiporelatorio = "select * from tiporelatorio";
		$resulttiporelatorio = mysql_query($sqltiporelatorio, $con);
		while ($rowtiporelatorio = mysql_fetch_array($resulttiporelatorio)) {
			
			$idtipo =  $rowtiporelatorio["id"];
			$tipo =  $rowtiporelatorio["tipo"];
		  
		  ?>
            <select name="tipo_relatorio" id="tipo_relatorio"  class="required">
              ...
              <a href="#"><img src="../imagens/add.png"  alt="" width="25" height="25" align="absmiddle"/></a></div></td>
          <td width="25%" bgcolor="#E9E9E9"><div class="solicitacao">
            <div class="texto"><span class="textomenorpretoB">Selecionar pdf:</span></div>
          </div></td>
          <td width="33%" bgcolor="#E9E9E9"><div class="solicitacao">
            <label for="nome3"></label>
            <label for="label"></label>
            <input type="file" name="pdf" id="pdf2" />
          </div></td>
        </tr>
        <tr>
...
echo "Embarcação não Encontrada! ".$idrb;	
}
