...
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="gravar_resp_mat.php" method="post">
  <span class="title">
...
include_once '../validar_obras.php';
        ...
        Cadastrar Responsável da Matriz</div></td>
    </tr>
    <tr>
      ...
      <td colspan="4" bgcolor="#E9E9E9"><div class="solicitacao">
        <div class="texto">
          <input name="respnome" type="text" required="required" class="required" id="respnome" value="" size="100" />
        </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao"> <span class="aviso">
        ...
        <input name="respemail" type="text" required="required" class="email" id="respemail" value="" size="35"  />
      </span></div></td>
    ...
    <tr>
      ...
      <td bgcolor="#E9E9E9"><div class="solicitacao">
        <div class="texto">
          <input name="respcpf" type="text" id="cpf" value="" size="25" />
        </div>
      </div></td>
      <td bgcolor="#E9E9E9"><div class="solicitacao">
      ...
      <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao"><span class="aviso">
        ...
        <input name="respcargo" type="text" id="respcargo" value="" size="25" />
      </div></td>
    </tr>
    <tr>
      <td bgcolor="#E9E9E9"><div class="solicitacao">
      ...
      <td bgcolor="#E9E9E9"><div class="solicitacao">
        <div class="texto">
          <input name="resptelefone" type="text" id="tel" value="" size="25" />
        </div>
      </div></td>
      <td bgcolor="#E9E9E9"><div class="solicitacao">
        <div class="textomenorpretoB">
      ...
      <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao"><span class="aviso">
        ...
        <input name="respcelular" type="text" id="telefone1" value="" size="25" />
        </span></div></td>
    </tr>
    <tr>
