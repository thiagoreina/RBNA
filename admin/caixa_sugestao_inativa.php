...
<script type="text/javascript">
            ...
            function excluir(id){
                if(confirm('Deseja realmente Excluir essa Sugestão?')){
                    //redirecionar para o excluir
                    location.href="exc_sugestao.php?id="+id;
                }
            }
...
<table width="100%" border="1">
  <tr>
    <td bgcolor="#FF0000"><div align="center"><span class="title">Sugestões INATIVAS</span>
      <?php

include_once '../fontes/conexao.php';
$sql = "SELECT * FROM sugestao where ativo = 0 ORDER BY data DESC";
...
while ($rowsetor = mysql_fetch_array ($resultsetor)){
    ...
    <td width="40%" bgcolor="#F3F3F3"><span class="textomenorpreto">Data : <?php echo $datafinal .$horafinal; ?></span></td>
    <td width="6%" bgcolor="#F3F3F3">
      <div align="center"><a href="ativar_sugestao.php?id=<?php echo $row["id"] ?>"><img src="../imagens/voltar.png" width="20" height="20" alt="Reativar Sugestão" title="Reativar Sugestão" /></a><span class="texto"></span>
    </div></td>
    <td width="5%" bgcolor="#F3F3F3">
      <div align="center"><a href="javascript:excluir('<?php echo $row["id"] ?>')"><img src="../imagens/delete.png" width="20" height="20" alt="Excluir Sugestão" title="Excluir Sugestão" /></a><span class="texto"></span>
    </div></td>
    </tr>
  <tr>
    <td colspan="23" bgcolor="#FFFFFF" class="textomenorpreto"><div class="solicitacao"><div align="left"><?php echo $msg ?>
      </div></div></td>
  ...
  <?php
	...
	echo "Nenhuma Sugestão Inativa !";
	}
?>
</table>
  </div>
  <div class="clear">
    <p><a href="caixa_sugestao.php"><span class="aviso">Ver Sugestões Ativas</span></a></p>
  </div>
