...
if (!empty($_GET["nome"])) { //SE NÃO VAZIO
    ...
    $sql = "select * from obras_ot where registro like '%" . $nome . "%' ORDER BY registro";
...
<div align="center"><table width="95%" border="0" cellpadding="2" cellspacing="2">
    ...
    <td  bgcolor=#666666 class='title'>Excluir</td>
       ...
       while ($row = mysql_fetch_array($result)) {
        ...
        <th bgcolor=#F2F2F2 class="texto"><div class="solicitacao"><a href="javascript:MM_openBrWindow('editar_obras_ot.php?id=<?php echo $row["id"] ?>','edit','width=920,height=500')"><img src="../imagens/edit.png" width="20" height="20" /></a></th>
