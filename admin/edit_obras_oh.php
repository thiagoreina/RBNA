      ...
      <script type="text/javascript">
            ...
            function excluir(id){
                if(confirm('Deseja realmente excluir essa Obra ?')){
                    ...
                    location.href="exc_obras_oh.php?id="+id;
                }
            }
         ...
         <script type="text/javascript">
            ...
            function ativar(id){
                if(confirm("Esta opção ativa a empresa será exibida na WEB. \nDeseja realmente Homologar essa Empresa ?")){
                    //redirecionar para o excluir
                    location.href="homologar.php?id="+id;
                }
            }
         ...
         <script type="text/javascript">
            ...
            function desativar(id){
                if(confirm('Deseja realmente desativar a Homologação dessa Empresa ?')){
                    //redirecionar para o excluir
                    location.href="homologar.php?id="+id;
                }
            }
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title"> Obras OH</div></td>
     ...
     <div align="center"></div></td>
      ...
      <div align="center">
        <div class="solicitacao"><span class="texto">Procurar nº registro:</span>
          <input type="text"  onkeyup="ajax('dados_obras_oh.php?nome='+this.value,'conteudo')" size="40"/>
        </div>
        <div class="clear"></div>
</div>
<label>
...
<?php
    ...
    $sql = "select * from obras_oh ORDER BY registro ";
