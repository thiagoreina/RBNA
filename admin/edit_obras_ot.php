      ...
      <script type="text/javascript">
            ...
            function excluir(id){
                if(confirm('Deseja realmente excluir essa Obra ?')){
                    ...
                    location.href="exc_obras_ot.php?id="+id;
                }
            }
...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="2" >
    <tr>
      ...
      <td width="37%" bgcolor="#FF0000"><div align="center" class="title">Obras OT</div></td>
    ...
    <tr>
      ...
      <div align="center">
        <div class="solicitacao"><span class="texto">Procurar nº registro:</span>
          <input type="text"  onkeyup="ajax('dados_obras_ot.php?nome='+this.value,'conteudo')" size="40"/>
        </div>
        <div class="clear"></div>
      </div>
<label>
...
<?php
    ...
    $sql = "select * from obras_ot ORDER BY registro ";
...
<div align="center"><table width="95%" border="0" cellpadding="2" cellspacing="2">
    ...
    <td  bgcolor=#666666 class='title'>Excluir</td>
       ...
       <?php while ($row = mysql_fetch_array($result)) { ?>
         ...
         <th bgcolor=#F2F2F2 class="texto"><div class="solicitacao"><a href="javascript:MM_openBrWindow('editar_obras_ot.php?id=<?php echo $row["id"] ?>','edit','width=920,height=530')"><img src="../imagens/edit.png" width="20" height="20" /></a></th>
