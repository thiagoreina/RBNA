...
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_end_corresp.php" method="post">
  <span class="title">
...
include_once '../validar_obras.php';
        ...
        $sql = "select * from endereco where matriz_idMatriz = ".$id." AND tipo_end_idtipo_end = 1";
 ...
 ?>
        ...
        EDITAR ENDEREÇO DE CORRESPONDÊNCIA</div></td>
      </tr>
    <tr>
