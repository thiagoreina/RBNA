...
<body bgcolor="#EEEEEE">
<form action="att_logo_obras_oh.php" method="post" enctype="multipart/form-data" name="form" id="form">
...
?>
		...
		?>
          Alterar logo da Obra <?php echo $registro ?></div>
      </div></td>
    </tr>
    <tr>
      <td width="17%" rowspan="3" bgcolor="#CCCCCC"><img src="../logo_homologadas/<?php echo $row["logo"] ?>" width="100" height="100" /></td>
      <td width="83%" bgcolor="#CCCCCC"><div class="solicitacao" align="center">
        <div class="texto"></div>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td bgcolor="#CCCCCC"><div class="solicitacao">
        ...
        <div align="center"><span class="aviso"> Se não selecionar nenhuma logo, a logo será removida</span>
