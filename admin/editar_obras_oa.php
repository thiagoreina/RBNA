...
?> 
 <?php
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_oa.php" method="post">
  <span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666" class="title"><div align="center">Editar Obras OA</div></td>
    </tr>
    <tr>
...
?>/>
  ...
  <tr>
    ...
    <td width="12%" bgcolor="#CCCCCC"><div class="solicitacao">
      <label for="ab"></label>
      <input type="reset" name="button" id="button" value="Cancelar" />
    </div></td>
    <td colspan="3" bgcolor="#DFDFDF"><div class="solicitacao">
