...
?> 
 <?php
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_og.php" method="post">
<span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Detalhes da Obra OG<span class="texto"></span></div>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F7F7F7"><div class="texto">
        <div class="solicitacao">
          <input name="embarcacao" type="text" class="required" id="textfield4" value="<?php echo $row["embarcacao"] ?>" size="100" />
          </span></div>
      </div></td>
    </tr>
    <tr>
