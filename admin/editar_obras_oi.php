...
?> 
 <?php
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_oi.php" method="post">
  <span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Detalhes da Obra OI<span class="texto"></span></div>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F7F7F7"><div class="texto">
        <div class="solicitacao">
          <input name="embarcacao" type="text" class="required" id="textfield3" value="<?php echo $row["embarcacao"] ?>" size="100" />
          </span></div>
      </div></td>
    </tr>
    <tr>
      ...
      <td width="39%" bgcolor="#F7F7F7"><div class="solicitacao">
        <input type="text" name="material" value="<?php echo $row["material"] ?>" id="textfield" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      ...
      <td bgcolor="#F7F7F7"><div class="solicitacao">
        <input type="text" name="qtddias" value="<?php echo $row["material"] ?>"  id="textfield7" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      ...
      <td rowspan="2" bgcolor="#F7F7F7"><div class="solicitacao">
        <input type="text" name="numerocasco" value="<?php echo $row["numerocasco"] ?>"  id="textfield4" />
      </div></td>
    </tr>
    <tr>
