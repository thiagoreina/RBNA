...
?> 
 <?php
        ...
        $sql = "select * from obras_om where id = ".$id;
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_om.php" method="post">
<span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Detalhes da Obra OM<span class="texto"></span></div>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="19%" bgcolor="#F7F7F7"><div class="solicitacao">
      ...
      <td width="48%" bgcolor="#F7F7F7"><div class="solicitacao">
    ...
    <tr>
      <td colspan="3" bgcolor="#EAEAEA"><div class="solicitacao">
        <table width="100%" border="0" cellpadding="2" cellspacing="2">
          <tr>
            <td bgcolor="#999999"><input name="forarbna2" type="checkbox"  id="forarbna2" value="1"  <?php if ($row["forarbna"] == 1){

   echo " checked='checked'";

}
?>/>              <label for="forarbna2"></label></td>
            <td bgcolor="#EAEAEA"><span class="textomenorpreto">Embarcação que não está no RBNA</span></td>
            <td bgcolor="#000000"><input  name="certrbna2" type="checkbox" id="certrbna2" value="1" <?php if ($row["certrbna"] == 1){

   echo " checked='checked'";

}
?>/>              <label for="certrbna2"></label></td>
            <td bgcolor="#EAEAEA" class="textomenorpreto">Embarcação certificada pelo RBNA</td>
            <td bgcolor="#FF0000"><input name="inadimplentes2" type="checkbox"  id="inadimplentes2" value="1" <?php if ($row["inadimplentes"] == 1){

   echo " checked='checked'";

}
?>/>              <label for="inadimplentes2"></label></td>
            <td bgcolor="#EAEAEA" class="textomenorpreto">Cliente inadimplente</td>
            <td bgcolor="#FF00FF"><input name="insatisfeitos2" type="checkbox" id="insatisfeitos2" value="1"  <?php if ($row["insatisfeitos"] == 1){

   echo " checked='checked'";

}
?>/>              <label for="insatisfeitos2"></label></td>
