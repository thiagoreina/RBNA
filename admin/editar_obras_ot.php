...
?> 
 <?php
		...
		$treinamento = str_replace("<br />", "", $row["treinamento"]);
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_ot.php" method="post">
<span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Detalhes da Obra OT<span class="texto"></span></div>
      </div></td>
    </tr>
    <tr>
...
?>/>              <label for="insatisfeitos"></label></td>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F7F7F7"><span class="solicitacao">
        <textarea name="treinamento" id="treinamento" cols="80" rows="5"> <?php echo $treinamento ?></textarea>
      </span></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
