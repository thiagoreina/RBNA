...
?> 
 <?php
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_ov.php" method="post">
  <span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666" class="title"><div align="center">Editar Obras OV</div></td>
    </tr>
    <tr>
  ...
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpreto"><b>BANDEIRA</b>:</div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <input name="bandeira" type="text" id="textfield5" value="<?php echo $row["bandeira"] ?>" />
    </div></td>
  ...
  <tr>
    ...
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpreto"><b>QNT. DIAS:</b></div>
    </div></td>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
...
?>/>
    ...
    </table>      <label for="servico"></label></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpreto"><b>SERVIÇO:</b></div>
    </div></td>
    <td colspan="3" bgcolor="#E9E9E9"><div class="solicitacao">
