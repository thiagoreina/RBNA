...
?> 
 <?php
        ...
        $sql = "select * from obras_ow where id = ".$id;
        ...
        ?>
<body bgcolor="#EEEEEE">  
<form id="form" name="editar_form" action="att_obras_ow.php" method="post">
  <span class="title">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td colspan="5" bgcolor="#666666"><div class="solicitacao">
        <div align="center" class="title">Detalhes da Obra OW<span class="texto"></span></div>
      </div></td>
    </tr>
    <tr>
      ...
      <td colspan="3" bgcolor="#F7F7F7"><div class="texto">
        <div class="solicitacao">
          <input name="contratante" type="text" class="required" id="textfield3" value="<?php echo $row["contratante"] ?>" size="100" />
          </span>
    ...
    <tr>
      ...
      <td width="39%" bgcolor="#F7F7F7"><div class="solicitacao">
        <input name="material" type="text" id="textfield9" value="<?php echo $row["material"] ?>" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      ...
      <td bgcolor="#F7F7F7"><div class="solicitacao">
        <input name="qtddias" type="text" id="textfield10" value="<?php echo $row["qtddias"] ?>" />
      </div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      ...
      <td colspan="2" rowspan="2" bgcolor="#DFDFDF">&nbsp;</td>
    </tr>
    <tr>
