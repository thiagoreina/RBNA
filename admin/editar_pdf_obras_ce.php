...
<body bgcolor="#EEEEEE">
<form action="att_pdf_obras_ce.php" method="post" enctype="multipart/form-data" name="form" id="form">
...
?>
  ...
  <input type="hidden" name="registro" id="registro" value="<?php echo $row["registro"] ?>"/>
  <br/>
</form>
