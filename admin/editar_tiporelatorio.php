...
<form id="form" name="attsetor" method="post" action="att_tiporelatorio.php" >
...
$id = $_GET["id"];
 ...
 $sql = "select * from tiporelatorio where id = ".$id;
...
?>
          Editar Tipo Relatório</div>
      </div></td>
    </tr>
    <tr>
      <td width="28%" bgcolor="#CCCCCC"><div class="solicitacao">
        <div class="textomenorpretoB">Tipo do Relatório:</div>
      </div></td>
      <td width="72%" bgcolor="#CCCCCC"><div class="solicitacao">
        <input name="id" type="hidden" value="<?php echo $_GET["id"]; ?>" />
        <input name="grupo" type="hidden" value="<?php echo $_GET["grupo"]; ?>" />
       
        <span class="aviso">
          <input name="tipo" type="text" class="required" id="login" value="<?php echo $row["tipo"]; ?>" size="25" />
        </span></div></td>
    </tr>
    <tr>
