...
$datatime = date('Y-m-j H:m:s');
		...
		$sql2 ="INSERT INTO log_obras VALUES ('', '".$registro."',
			...
			$sql ="INSERT INTO obras_oa VALUES ('', '".$registro."', '".$embarcacao."', '".$numerocasco."', '".$contratante."', '".$armador."', '".$regiao."', '".$tipoembarcacao."', '".$pagamento."', '".$areanavegacao."', '".$bandeira."', '".$ab."', '".$kw."', '".$obs."', ".$forarbna.", ".$certrbna.", ".$inadimplentes.", ".$insatisfeitos.", '".$nome_pdf."')";
		
			// Se os dados forem inseridos com sucesso
		if(mysql_query($sql, $con)){
			mysql_query($sql2, $con);
				 $msg = "Salvo com sucesso.";
				 header("location:cad_obras_oa.php?msg=".$msg);
			}else{
				 $msg = "Erro ao Salvar.";
				 header("location:cad_obras_oa.php?msg=".$msg);
				}
