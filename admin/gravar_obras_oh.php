...
if (!empty($logo['name'])) {
        	...
        	$caminho_imagem = "../logo_homologadas/" . $nome_imagem;
...
// Parte do PDF
 ...
 $sqlregistro = "select * from obras_oh where registro = '".$registro."' ";
	...
	$row = mysql_fetch_array($result); {
	 	...
	 	if($row["registro"] == $registro){
				 ...
				 header("location:cad_obras_oh.php?msg=".$msg);
	}else{
...
$datatime = date('Y-m-j H:m:s');
		...
		$sql2 ="INSERT INTO log_obras VALUES ('', '".$registro."',
			...
			$sql ="INSERT INTO obras_oh VALUES ('', '".$registro."',
			   '".$contratante."',
				 '".$tipo_oh."',
				 '".$regiao."',
				   '".$pagamento."',
