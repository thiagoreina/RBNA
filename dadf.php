...
<div class="esquerda">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td bgcolor="#80C2E3" class="textomenorpreto"> Título:</td>
      <td width="12%" bgcolor="#80C2E3" class="textomenorpreto">Arquivo:</td>
    </tr> <?php 

 
 $sqlmanual = "SELECT * FROM dadf where tipo like 'modelo' ";
...
while ($rowmanual = mysql_fetch_array ($resultmanual)){
    ...
    <tr>
      ...
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="center"><a href="departamentos/dadf/<?php echo $rowmanual["arquivo"] ?>" target="_blank"><img src="imagens/archive.png" width="20" height="20" /></a></div></td>
    </tr>
    <?php
}
?>
 ...
 $sqltrabalho = "SELECT * FROM dadf where tipo like 'trabalho' ";
...
while ($rowtrabalho = mysql_fetch_array ($resulttrabalho)){
    ...
    <tr>
      ...
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="center"><a href="departamentos/dadf/<?php echo $rowtrabalho["arquivo"] ?>" target="_blank"><img src="imagens/pdf.png" alt="" width="20" height="20" /></a></div></td>
    </tr>
    <?php
}
?>
 ...
 <div class="direita"> 
  <table width="100%" border="0">
    <tr>
      <td bgcolor="#0099CC" class="title"><div align="center">Departamento Pessoal</div></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
 ...
 $sqlprocedimento = "SELECT * FROM dadf where tipo like 'dp' ";
...
while ($rowprocedimento = mysql_fetch_array ($resultprocedimento)){
    ...
    <tr>
      ...
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="center"><a href="departamentos/dadf/<?php echo $rowprocedimento["arquivo"] ?>" target="_blank"><img src="imagens/archive.png" alt="" width="20" height="20" /></a></div></td>
    </tr>
    <?php
}
?>
