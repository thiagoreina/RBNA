...
if (!empty($_GET["nome"])) { //SE NÃO VAZIO
    ...
    $sql = "select * from obras_oa where registro like '%" . $nome . "%'";
...
/*
    ...
    $sql = "select * from obras_oa ORDER BY registro ";
...
if ($contagemcontratante > '25') {
 ...
 ?></td>
         <th width="10%" class="texto"><div class="solicitacao"><a href="javascript:MM_openBrWindow('detalhe_obras_oa.php?id=<?php echo $row["id"] ?>','edit','width=1020,height=430')"><img src="imagens/detalhe.png" width="20" height="20" /></a></th>
...
<?php
        ...
        echo "<p> </p><p class='texto'> <img src='imagens/alert.png' width='24' height='24' align='absmiddle' />Nenhuma Obra encontrada<img src='imagens/alert.png' width='24' height='24' align='absmiddle' /></p>";
