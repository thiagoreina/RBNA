...
if (!empty($_GET["nome"])) { //SE NÃO VAZIO
    ...
    $sql = "select * from obras_om where registro like '%" . $nome . "%'";
...
if ($contagemcontratante > '25') {
 ...
 ?></td>
         ...
         <th width="10%" class="texto"><div class="solicitacao"><a href="javascript:MM_openBrWindow('detalhe_obras_om.php?id=<?php echo $row["id"] ?>','edit','width=1020,height=400')"><img src="imagens/detalhe.png" width="20" height="20" /></a></th>
