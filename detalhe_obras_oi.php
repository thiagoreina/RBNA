...
<div align="center" class="total">
 ...
 if (!empty($_GET["id"])){
	...
	$sql= "select * from obras_oi where id = ".$id;
	...
	$sql= "select * from obras_oi where registro = '".$id."'";
 ...
 ?>
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    ...
    <tr>
      ...
      <span class="solicitacao"><span class="texto"><?php echo $row['embarcacao'] ?></span></span></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      ...
      <td width="27%" bgcolor="#F7F7F7"><div class="solicitacao">
        <span class="solicitacao"><span class="texto"><?php echo $row['registro'] ?></span></span>
      <div class="texto"></span></div></td>
      <td width="16%" bgcolor="#DFDFDF"><div class="solicitacao">
        <div class="texto"><span class="textomenorpreto">MATERIAL:</span></div>
      </div></td>
      <td width="39%" bgcolor="#F7F7F7"><div class="solicitacao"><span class="texto"><?php echo $row['material'] ?></span></div></td>
    </tr>
    <tr>
      <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      ...
      <td bgcolor="#F7F7F7"><div class="solicitacao">
        <span class="solicitacao"><div class="texto"><?php echo $row['regiao'] ?></span>
      </span></div></td>
    ...
    <tr>
      ...
      <td rowspan="2" bgcolor="#F7F7F7"><div class="texto">
        <div class="solicitacao"><?php echo $row['pagamento'] ?></div>
      </div></td>
      <td rowspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
        <div class="texto"><span class="textomenorpreto">Nº CASCO:</span></div>
      </div></td>
      <td rowspan="2" bgcolor="#F7F7F7"><div class="solicitacao"><span class="texto"><?php echo $row['numerocasco'] ?></span></div></td>
    </tr>
    <tr>
...
?>              <label for="insatisfeitos"></label></td>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#F7F7F7"><span class="solicitacao"><span class="solicitacao"><span class="texto"><?php echo $row['obs'] ?></span></span>
