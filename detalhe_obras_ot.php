...
<div align="center" class="total">
 ...
 include_once "fontes/conexao.php";
  if (!empty($_GET["id"])){
	...
	$sql= "select * from obras_ot where id = ".$id;
	...
	$sql= "select * from obras_ot where registro = '".$id."'";
 ...
 ?>
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#F7F7F7"><div class="texto">
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#EAEAEA"><div class="solicitacao">
        <table width="100%" border="0" cellpadding="2" cellspacing="2">
          <tr>
...
?>              <label for="insatisfeitos"></label></td>
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#F7F7F7"><span class="solicitacao"><span class="texto"><?php echo $row['treinamento'] ?></span>
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#F7F7F7"><span class="solicitacao"><span class="texto"><?php echo $row['obs'] ?></span>
      <div class="texto"></div></td>
    </tr>
  </table>
  <div class="clear">
