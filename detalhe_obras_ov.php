...
<div align="center"></div>
 ...
 if (!empty($_GET["id"])){
	...
	$sql= "select * from obras_ov where id = ".$id;
	...
	$sql= "select * from obras_ov where registro = '".$id."'";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td width="39%" bgcolor="#F7F7F7"><div class="solicitacao"><span class="texto"><span class="texto"><?php echo $row['numerocasco'] ?></span></span>
  ...
  <tr>
    ...
    <td bgcolor="#F7F7F7"><div class="solicitacao">
      <div class="texto"><?php echo $row['ab'] ?></span></div>      
      </td>
    <td bgcolor="#DFDFDF"><div class="solicitacao">
  ...
  <tr>
    ...
    <td bgcolor="#F7F7F7"><div class="texto"><div class="solicitacao"><?php echo $row['qtddias'] ?></span></div></td>
...
?></td>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#F7F7F7"><span class="solicitacao"><div class="texto"><?php echo $row['servico'] ?></span>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#F7F7F7"><span class="solicitacao"><div class="texto"><?php echo $row['obs'] ?></span></td>
  </tr>
  </table>
