...
<div align="center" class="total">
 ...
 include_once "fontes/conexao.php";
  if (!empty($_GET["id"])){
	...
	$sql= "select * from obras_ow where registro = '".$id."'";
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#F7F7F7"><div class="texto">
      <div class="solicitacao"><?php echo $row['contratante'] ?></span></div>
    </div></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
    ...
    <td width="39%" bgcolor="#F7F7F7"><div class="solicitacao"><span class="texto"><span class="texto"><?php echo $row['material'] ?></span></span>
  ...
  <tr>
    ...
    <td bgcolor="#F7F7F7"><div class="solicitacao">
     ...
     <span class="texto"> <?php echo $row['qtddias'] ?></span></div></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
    ...
    <td rowspan="2" bgcolor="#F7F7F7"><div class="texto">
      <div class="solicitacao"><?php echo $row['pagamento'] ?></div></div></td>
...
?></td>
  ...
  <tr>
    ...
    <td colspan="3" bgcolor="#F7F7F7"><span class="solicitacao">
      <div class="texto"><?php echo $row['obs'] ?></div></td>
  </tr>
  </table>
