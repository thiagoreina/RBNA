...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
 ...
 if (!empty($_GET["id"])){
	...
	$sql= "select * from obras_rb where registro = '".$id."'";
 ...
 ?>
  ...
  <tr>
    ...
    <td bgcolor="#F7F7F7"><div class="solicitacao">
      <div class="texto"><div class="texto"><?php 
	  
	  $sqlCliente= "select * from matriz where idMatriz = ".$id_matriz;

 $resultCliente = mysql_query($sqlCliente, $con);

 $rowCliente = mysql_fetch_array($resultCliente);
 
  echo $rowCliente["fantasia"] ?></span></div>
    </div></td>
  ...
  <tr>
    <td colspan="2" bgcolor="#DFDFDF"><div class="texto">
      <div class="solicitacao"><span class="textomenorpreto">BANDEIRA:</span></div>
    </div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao"><div class="texto"><?php echo $row["bandeira"] ?></span>

    </div></td>
    <td bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto"><span class="textomenorpreto">COMPRIMENTO (L):</span></div>
    </div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao"><div class="texto"><?php echo $row["comprimento"] ?></span></div></td>
    </tr>
  <tr>
    <td colspan="2" bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto"><span class="textomenorpreto">AB:</span></div>
    </div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao"><div class="texto"><?php echo $row["ab"] ?></span></div></td>
    <td bgcolor="#DFDFDF"><div class="solicitacao">
      <div class="texto"><span class="textomenorpreto">KW:</span></div>
    </div></td>
    <td bgcolor="#F7F7F7"><div class="solicitacao"><div class="texto"><?php echo $row["kw"] ?></span>
...
?></td>
            ...
            <td width="4%" bgcolor="#FF0000"><?php if ($rowCliente["inadimplente"] == 1){
...
?></td>
            ...
            <td width="4%" bgcolor="#FF00FF"><?php if ($rowCliente["insatisfeito"] == 1){
