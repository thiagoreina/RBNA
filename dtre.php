...
<div class="esquerda"> 
  <table width="100%" border="0">
    <tr>
      <td bgcolor="#0099CC" class="title"><div align="center">Materiais de Treinamento</div></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td bgcolor="#80C2E3" class="textomenorpreto">Material:</td>
      <td width="12%" bgcolor="#80C2E3" class="textomenorpreto">PDF:</td>
    </tr>
    <?php 

 
 $sqlprocedimento = "SELECT * FROM dtre where tipo like 'material' ";
$resultprocedimento = mysql_query($sqlprocedimento, $con);
while ($rowprocedimento = mysql_fetch_array ($resultprocedimento)){
	?>
    <tr>
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="left"><?php echo $rowprocedimento["titulo"] ?>&nbsp;</div></td>
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="center"><a href="departamentos/dtre/<?php echo $rowprocedimento["arquivo"] ?>" target="_blank"><img src="imagens/pdf.png" alt="" width="20" height="20" /></a></div></td>
    </tr>
    <?php
}
?>
...
<div class="direita"> 
  <table width="100%" border="0">
    <tr>
      <td bgcolor="#0099CC" class="title"><div align="center">Programa de Treinamento</div></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td bgcolor="#80C2E3" class="textomenorpreto">Programa:</td>
      <td width="12%" bgcolor="#80C2E3" class="textomenorpreto">PDF:</td>
    </tr>
    <?php 

 
 $sqlprograma = "SELECT * FROM dtre where tipo like 'programa' ";
$resultprograma = mysql_query($sqlprograma, $con);
while ($rowprograma = mysql_fetch_array ($resultprograma)){
	?>
    <tr>
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="left"><?php echo $rowprograma["titulo"] ?>&nbsp;</div></td>
      <td bgcolor="#E4E4E4" class="textomenorpreto"><div align="center"><a href="departamentos/dtre/<?php echo $rowprograma["arquivo"] ?>" target="_blank"><img src="imagens/pdf.png" alt="" width="20" height="20" /></a></div></td>
    </tr>
    <?php
}
?>
