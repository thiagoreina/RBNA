...
<p align="center"><img src="imagens/avisosenha.png" width="129" height="129" align="middle" /></p>
<p align="center" class="inativo"><img src="imagens/alert.png" width="24" height="24" align="absmiddle" /> Essa é uma Senha Padrão, Você Deve Trocar <img src="imagens/alert.png" alt="" width="24" height="24" align="absmiddle" /></p>
<form id="form" name="editar_senha" method="post" action="att_senha_padrao.php" >
  <div align="center">
...
?>
      ...
      <tr>
        <td width="47%" bgcolor="#DFDFDF"><div class="solicitacao">
          <div class="texto">Nova Senha:</div>
        </div></td>
        <td width="53%" bgcolor="#F7F7F7"><div class="solicitacao"><span class="aviso">
