...
<div class="direita">
  <table width="100%" border="1">
    <tr>
      <td bgcolor="#0099CC"><div align="center"><span class="title">Criar Solicitação</span>
...
$databd = date('Y-m-d H:i:s');
$databr = date('d/m/Y');

?>
  <form action="gravar_solicitacao.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" >
  
  <table width="100%" border="0">
    <tr>
      <td width="44%" bgcolor="#CCCCCC" class="textomenorpreto"><div class="solicitacao"><span class="texto"><?php echo $nome[0]; ?></span></div></td>
      <td colspan="2" bgcolor="#CCCCCC"><div class="solicitacao"><span class="textomenorpreto">Data : <?php echo $databr; ?></span></div></td>
    </tr>
    <tr>
      <td height="123"><div class="solicitacao">
        <div align="center">
        <input type="hidden" name="nome" value="<?php echo $databd ?>"/>
        <input type="hidden" name="idfunc" value="<?php echo $_SESSION["idfunc"] ?>"/>
                
        <label>
      <select name="setor" required="required" class="required" id="setor" >
        <option value="">Solicitar Para:</option>
      ...
      <td height="123" colspan="2"><div class="solicitacao"><textarea name="solicitacao" cols="37" rows="6" autofocus="autofocus" required="required" class="required" id="solicitacao"></textarea></div></td>
    </tr>
    <tr>
      ...
      <td width="16%"><div class="solicitacao">
        <div align="right">
...
<div class="esquerda">
  <table width="100%" border="1">
    <tr>
      <td bgcolor="#0099CC"><div align="center"><span class="title">Histórico de Solicitações</span></div></td>
    </tr>
  </table>
<?php
...
$sql= "select * from solicitacao where id_funcionario = ".$_SESSION["idfunc"]." ORDER BY data DESC LIMIT 0,5";
...
while ($row = mysql_fetch_array ($result)){
   ...
   $datatime = explode(" ",$data);
	...
	$data = $dia."/".$mes."/".$ano;
		  ...
		  echo "<a href='#' ><span class='textomenorpretoB'>".$pendente." Solicitação Para: ".$rowsetor["setor"]." ".$data."</span></a></h3>
    <div>
      <p>".$solicitacao."</p>
    </div>
...
?>
  ...
  <div class="clear"></div>
  <?php
  $sqluser = "select gerente from funcionario where id_funcionario = ".$_SESSION["idfunc"];
  ...
  if($gerente == 1){
	echo "<br><a href='ver_solicitacao.php'>Ver solicitações para o seu setor</a>";   
  }
