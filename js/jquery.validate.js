...
$.extend($.validator, {
	...
	messages: {
		required: "<img src='images/alert.png' width='20' height='20' align='absmiddle' />",
		remote: "Please fix this field.",
		email: "<span class='aviso'>E-mail Invalido.<span>",
		url: "<span class='aviso'>URL Invalida.<span>",
		date: "Please enter a valid date.",
		dateISO: "Please enter a valid date (ISO).",
		dateDE: "Bitte geben Sie ein gÃ¼ltiges Datum ein.",
		number: "Insira um nÃºmero vÃ¡lido.",
		numberDE: "Bitte geben Sie eine Nummer ein.",
		digits: "Please enter only digits",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "As senhas nÃ£o confirmam",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("Insira no mÃ¡ximo {0} caracters"),
