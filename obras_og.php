...
if ($contagemcontratante > '25') {
 ...
 ?></td>
         ...
         <th width="10%" class="texto"><div class="solicitacao"><a href="javascript:MM_openBrWindow('detalhe_obras_og.php?id=<?php echo $row["id"] ?>','edit','width=1020,height=350')"><img src="imagens/detalhe.png" width="20" height="20" /></a></th>
