...
if ($contagemcontratante > '38') {

   echo $row['contratante'];
}
?>"><div class='solicitacao'><?php echo substr($row['contratante'],0,38);
...
if ($contagemcontratante > '38') {
 ...
 ?></td>
         ...
         <th width="10%" class="texto"><div class="solicitacao"><a href="javascript:MM_openBrWindow('detalhe_obras_oh.php?id=<?php echo $row["id"] ?>','edit','width=1020,height=450')"><img src="imagens/detalhe.png" width="20" height="20" /></a></th>
