...
$sqlCliente = "select idMatriz, fantasia, inadimplente, insatisfeito from matriz where idMatriz = ".$row['id_matriz'];
...
if ($contagemreg > '5') {
 ...
 ?></td>
           <td width="19%" class='textomenorpreto' title="<?php $contagemembarcacao = strlen($row['embarcacao']);
...
if ($contagemembarcacao > '25') {
 ...
 <td width="19%" class='textomenorpreto' title="<?php $contagemtipo = strlen($row['tipoembarcacao']);
...
?>"><a href="detalhes_cliente.php?id=<?php echo $rowCliente['idMatriz'] ?>"><div class="solicitacao" style="height:20px"><?php echo substr($rowCliente['fantasia'],0,35);
...
$dataformat =date('d/m/Y H:i:s', $timestamp1);
 ...
 ?></div></td>
          <th width="7%" class="textomenorpreto"><div class="solicitacao" style="height:20px"><a href="javascript:MM_openBrWindow('detalhe_obras_rb.php?id=<?php echo $row["id"] ?>','edit','width=1020,height=330')" onmouseover="tooltip.show('Ultima Atualização: <br> <?php echo $dataformat ?>');" onmouseout="tooltip.hide();">
          <div align="center"><img src="imagens/detalhe.png" style="border:none" width="20" height="20" align="absmiddle" /></div></a></div></th>
         <th width="4%" class="texto"><div class="solicitacao" style="height:20px">
...
?></th>
<th width="3%" class="texto" bgcolor=""><div class="solicitacao" align="center" style="width:20px ; height:20px"><?php if ($rowCliente['inadimplente'] == 1){
...
?></th>
<th width="5%" class="texto" bgcolor=""><div  class="solicitacao" align="center" style="width:20px ; height:20px"><?php if ($rowCliente['insatisfeito'] == 1){
