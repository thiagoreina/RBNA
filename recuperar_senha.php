...
<form id="form" name="editar_senha" method="post" action="att_senha_recuperar.php" >
  <div align="center">
    <p>&nbsp;</p>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
...
$idfunc = $_GET["id2"];
$validade = $_GET["86400"];
$validadelink = 6*3600 ; // 6 Horas

if (time() <= ($validade + $validadelink)){
	



$sqlfunc = "select * from funcionario where id_funcionario = ".$idfunc;
 

        $resultfunc = mysql_query($sqlfunc,$con);

        $rowfunc = mysql_fetch_array($resultfunc);
		
		$idbd = md5($rowfunc["id_funcionario"]);
...
?>
      ...
      <tr>
        <td width="50%" bgcolor="#DFDFDF"><div class="solicitacao">
          <div class="texto">Nova Senha:</div>
        </div></td>
        <td width="50%" bgcolor="#F7F7F7"><div class="solicitacao"><span class="aviso">
...
echo "Link Fora da Validade, Lembrando que o Link de Recuperação de senha tem validade de 6 Horas.";
