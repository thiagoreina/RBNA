...
<p>&nbsp;</p>
<form action="gravar_matriz.php" method="post" enctype="multipart/form-data" name="cadastro" id="form" ><table width="90%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td colspan="2" bgcolor="#666666"><a href="cad_matriz.php"><div class="solicitacao">
      <div align="center" class="title">Responsável</div>
    </div></a></td>
    <td bgcolor="#666666"><a href="cad_endereco.php"><div class="solicitacao">
  ...
  <tr>
    <td width="23%" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpretoB">Nome:</div>
    </div></td>
    <td colspan="5" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="texto">
        <input name="razao" type="text" id="razao" size="100" class="required" />
        </div>
    </div></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="19%" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="texto">
        <input type="text" name="cnpj" id="textfield2" />
        </div>
    </div></td>
    <td width="24%" bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="textomenorpretoB">
        <div align="right">Cargo:</div>
      </div>
    </div></td>
    <td width="34%" colspan="3" bgcolor="#E9E9E9"><div class="solicitacao"><span class="aviso">
      <label for="numerocasco"></label>
    </span> 
        <input type="text" name="cpf" id="textfield4" />
    </div></td>
    </tr>
  <tr>
    <td bgcolor="#E9E9E9"><div class="solicitacao">
    ...
    <td bgcolor="#E9E9E9"><div class="solicitacao">
      <div class="texto">
        <input type="text" name="inscmunicipal" id="inscmunicipal" />
    ...
    <td colspan="3" bgcolor="#E9E9E9"><div class="solicitacao"><span class="aviso">
      <label for="razao"></label>
    </span>
        
        <span class="texto">
        <input type="text" name="inscestadual" id="textfield3" />
        </span></div></td>
    </tr>
  <tr>
